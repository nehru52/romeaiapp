...
if ($GRAPHIFY_PYTHON) {
    ...
    (Resolve-Path D:\romeaiapp).Path | Out-File -FilePath graphify-out\.graphify_root -Encoding utf8 -NoNewline
    Write-Host "OK: $GRAPHIFY_PYTHON"
} else {
