...
let scene, camera, renderer, _controls, clock;
...
function setCameraFromPose(pose, camWidth, camHeight) {
  ...
  const _camPos = t.clone().applyMatrix3(Rt).negate();
