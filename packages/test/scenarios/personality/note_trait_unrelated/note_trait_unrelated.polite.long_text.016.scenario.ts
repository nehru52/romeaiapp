 ...
 *
 * User mentions the 'no_exclamation' trait on turn 1 inside a benign request. The agent is then probed with 21 unrelated topics. The trait must be respected on every probe (especially turn 3+).
 *
