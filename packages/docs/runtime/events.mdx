...
enum EventType {
  ...
  // Pipeline hooks (HOOK_*) — see packages/core/src/types/events.ts
  ...
  // Platform-specific event channels
  DISCORD = "DISCORD",
  TELEGRAM = "TELEGRAM",
  X = "X",
}
...
const myPlugin: Plugin = {
  ...
  events: {
    ...
    [EventType.RUN_ENDED]: [cleanupRun],
  },
};
```
...
<Card title="Services" icon="server" href="/runtime/services">
  ...
  <Card title="Messaging" icon="message" href="/runtime/events">
