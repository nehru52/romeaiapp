...
The [`knowledge`](/plugins/overview) plugin transforms agents into domain experts by automatically processing documents and injecting relevant knowledge into conversations via RAG (Retrieval-Augmented Generation).
...
<Tip>
  **Guides**: [Customize an Agent](/user/change-character) | [Multiple
  Agents](/agents/runtime-and-lifecycle)
</Tip>
