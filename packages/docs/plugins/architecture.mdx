...
<Tip>**Guide**: [Create a Plugin](/plugins/create-a-plugin)</Tip>
...
For the complete TypeScript interface definition, see [Plugin Reference](/plugins/schemas#plugin-interface).
...
Components are registered in this specific sequence. For component details, see [Plugin Components](/plugins/architecture).
...
<CardGroup cols={2}>
  <Card title="Plugin Components" icon="cube" href="/plugins/architecture">
...
<Card title="Common Patterns" icon="lightbulb" href="/plugins/patterns">
  ...
  <Card title="Plugin Reference" icon="book" href="/plugins/schemas">
