...
const steps = [
  {
    ...
    description:
      "Drop in your business URL. Our AI analyzes your brand voice, detects your industry, and extracts your products and services automatically.",
    code: `instagram.connect({ apiKey: '••••' })
tiktok.connect({ apiKey: '••••' })
pinterest.connect({ apiKey: '••••' })
...
// 6 platforms, one dashboard`,
  },
  {
    ...
    description:
      "DeepSeek V4 writes captions, carousels, and reel scripts in your brand voice. FLUX generates matching images. Content ready in seconds.",
    code: `ai.generate({
  type: 'carousel',
  platform: 'instagram',
  topic: 'Vatican evening tours',
  tone: 'warm, insider knowledge'
})

// Content ready in seconds`,
  },
  {
    number: "III",
    title: "Review & approve",
    description:
      "Get notified on Telegram when drafts are ready. Review on your phone. One tap to approve. Content is reviewed by you before anything goes out.",
    code: `notification.sent({
  title: '5 Vatican posts ready',
  action: 'Review in dashboard'
})

// Approve. Publish. Book tours.`,
  },
];
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        <div className="mb-16 lg:mb-24">
          ...
          >
            Three steps.
            <br />
            <span className="text-background/50">Infinite bookings.</span>
          </h2>
        </div>
