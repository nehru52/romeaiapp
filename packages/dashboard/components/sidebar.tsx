    ...
    <>
      ...
      >
        <div className="flex h-14 items-center border-b px-4">
          <span className="text-lg font-semibold">Social AI Admin</span>
          <Button
            variant="ghost"
            size="icon"
...
const navItems = [
  ...
  { name: "Content", href: "/dashboard/content", icon: Users },
  { name: "Calendar", href: "/dashboard/calendar", icon: Wallet },
