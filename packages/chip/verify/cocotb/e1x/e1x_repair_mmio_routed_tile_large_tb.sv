...
module e1x_repair_mmio_routed_tile_large_tb (
  input  logic clk,
  input  logic rst_n,
  input  logic clear,
  ...
  output logic repair_programmer_busy,
  output logic repair_programmer_error,
  output logic [31:0] repair_programmer_words_pushed,
  ...
  e1x_repair_mmio_routed_tile #(
    ...
    .repair_programmer_busy_o(repair_programmer_busy),
    .repair_programmer_error_o(repair_programmer_error),
    .repair_programmer_words_pushed_o(repair_programmer_words_pushed),
