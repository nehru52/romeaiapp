...
buffer scaffolds and L2 cache slice banks at 130 nm. Generated artifacts
(LEF/GDS/Liberty/SPICE) land under build/ and feed pd/macros/manifest.yaml
after verification.

Build with:

    pd/macros/sky130/build_openram_macro.sh pd/macros/sky130/e1_sram_16kb_1rw
"""
...
# widest supported, predecode4x16) gives 512 columns x 256 rows for
