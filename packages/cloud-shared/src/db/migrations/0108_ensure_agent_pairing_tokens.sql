-- Ensure the current Agent pairing-token table exists after legacy
-- eliza_* table renames. Some environments skipped the original
-- eliza_pairing_tokens migration but run code that writes agent_pairing_tokens.
