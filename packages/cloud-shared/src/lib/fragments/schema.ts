...
/**
 * Fragment schema for structured code generation
 * Based on fragments app schema, adapted for Eliza Cloud
 */
...
/**
 * Schema for morph edit instructions (code updates)
 */
