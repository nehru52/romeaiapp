...
type PromptBenchmarkCase = Awaited<
  ReturnType<
    typeof import("../../../plugins/plugin-personal-assistant/test/helpers/lifeops-prompt-benchmark-cases.ts")["buildLifeOpsPromptBenchmarkCases"]
  >
>[number];
...
async function loadCases(
  ...
  const {
    ...
    "../../../plugins/plugin-personal-assistant/test/helpers/lifeops-prompt-benchmark-cases.ts"
  );
  if (suite === "self-care") {
