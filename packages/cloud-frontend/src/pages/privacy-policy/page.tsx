  ...
  return (
    <div className="theme-cloud flex min-h-screen w-full flex-col bg-black font-poppins text-white">
      <Helmet>
        ...
        <meta
          name="description"
          content={t("cloud.privacy.metaDescription", {
            defaultValue:
              "Privacy Policy for Eliza Cloud, including how information is collected, used, retained, and protected.",
          })}
        />
      </Helmet>
