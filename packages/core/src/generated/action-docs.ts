...
export const allActionsSpec = {
	...
	actions: [
		...
		},
		{
			name: "CAPTURE_LEAD",
			description:
				"Capture a new lead from social media into the booking funnel",
			parameters: [],
			similes: [
				"CAPTURE_LEAD",
				"NEW_LEAD",
		...
		},
		{
			...
			descriptionCompressed:
				"Generate an image using the optimal AI model for the content type. Routes automatically: photoreal→FLUX. 2 Pro, text_heavy→Ideogram 3. 0, brand_asset→Imagen...",
		},
		{
			name: "GENERATE_VIDEO",
			description:
			...
			descriptionCompressed:
				"Generate a video using the Tiered Cinematic Pipeline. Routes to the optimal model based on tier: hero (Veo 3. 1), standard (Kling 3. 0), product (Runway), or...",
		},
		{
		...
		},
		{
			...
			description:
				"Send the next nurture email in the 5-email sequence to a lead",
			parameters: [],
			similes: [
				"SEND_EMAIL",
				"NURTURE_EMAIL",
