 ...
 */
export const DEFAULT_SETUP_MESSAGES = {
	welcome: [
 ...
 */
export const COMMON_API_KEY_SETTINGS: Record<string, Partial<SetupSetting>> = {
	OPENAI_API_KEY: {
		name: "OpenAI API Key",
...
export function createSetupConfig(
	requiredKeys: string[],
	optionalKeys: string[] = [],
	customSettings: Record<string, Partial<SetupSetting>> = {},
): SetupConfig {
	const settings: Record<string, SetupSetting> = {};
