...
__global__ void calc_gqa_score_kernel(
    T* query_states,
    ...
    float* scores,
    int batch_size, int key_head_size, int n_size, int group_size, int gqa_group_size, int sketch_dim,
    int outlier_sketch_dim, int emb_dim, int outlier_counts) {

    size_t k_bh = blockIdx.x;
    size_t n = blockIdx.y;
    ...
    __shared__ float shared_query[GQA_GROUP_SIZE][EMB_DIM];
    ...
    __shared__ float shared_innprod[GQA_GROUP_SIZE][WARP_SIZE];
    __shared__ float shared_outlier_innprod[GQA_GROUP_SIZE][WARP_SIZE];
    ...
    __shared__ float shared_q_sketch[GQA_GROUP_SIZE][WARP_SIZE][8];
    __shared__ float shared_q_outliers_sketch[GQA_GROUP_SIZE][WARP_SIZE][8];
...
torch::Tensor QJLGQAScoreCudaTemplate(
    ...
    TORCH_CHECK(emb_dim == EMB_DIM,
        "QJL gqa score kernel: runtime emb_dim (", emb_dim,
    ...
    calc_gqa_score_kernel<T, Tproj, EMB_DIM><<<numBlocks, threadsPerBlockDim>>>(
        query_states_ptr,
        ...
        batch, k_head, n, group_size, gqa_group_size, sketch_dim, outlier_sketch_dim, emb_dim, outlier_counts);
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("qjl_gqa_score_cuda_half_float_h128", &QJLGQAScoreCudaTemplate<c10::Half, float, 128>, "GQA score kernel using Half to Float precision (head_dim=128)",
          py::arg("key_quant"),
          py::arg("key_outlier_quant"),
          py::arg("key_norm"),
          py::arg("key_outlier_norm"),
    ...
    m.def("qjl_gqa_score_cuda_float_float_h128", &QJLGQAScoreCudaTemplate<float, float, 128>, "GQA score kernel using Float precision (head_dim=128)",
          py::arg("key_quant"),
          py::arg("key_outlier_quant"),
          py::arg("key_norm"),
          py::arg("key_outlier_norm"),
    ...
    m.def("qjl_gqa_score_cuda_bf16_bf16_h128", &QJLGQAScoreCudaTemplate<at::BFloat16, at::BFloat16, 128>, "GQA score kernel using BF16 precision (head_dim=128)",
          py::arg("key_quant"),
          py::arg("key_outlier_quant"),
          py::arg("key_norm"),
          py::arg("key_outlier_norm"),
    ...
    m.def("qjl_gqa_score_cuda_bf16_float_h128", &QJLGQAScoreCudaTemplate<at::BFloat16, float, 128>, "GQA score kernel using BF16 to Float precision (head_dim=128)",
          py::arg("key_quant"),
          py::arg("key_outlier_quant"),
          py::arg("key_norm"),
          py::arg("key_outlier_norm"),
    ...
    m.def("qjl_gqa_score_cuda_half_float_h256", &QJLGQAScoreCudaTemplate<c10::Half, float, 256>, "GQA score kernel using Half to Float precision (head_dim=256)",
          py::arg("key_quant"),
          py::arg("key_outlier_quant"),
          py::arg("key_norm"),
          py::arg("key_outlier_norm"),
    ...
    m.def("qjl_gqa_score_cuda_float_float_h256", &QJLGQAScoreCudaTemplate<float, float, 256>, "GQA score kernel using Float precision (head_dim=256)",
          py::arg("key_quant"),
          py::arg("key_outlier_quant"),
          py::arg("key_norm"),
          py::arg("key_outlier_norm"),
    ...
    m.def("qjl_gqa_score_cuda_bf16_bf16_h256", &QJLGQAScoreCudaTemplate<at::BFloat16, at::BFloat16, 256>, "GQA score kernel using BF16 precision (head_dim=256)",
          py::arg("key_quant"),
          py::arg("key_outlier_quant"),
          py::arg("key_norm"),
          py::arg("key_outlier_norm"),
    ...
    m.def("qjl_gqa_score_cuda_bf16_float_h256", &QJLGQAScoreCudaTemplate<at::BFloat16, float, 256>, "GQA score kernel using BF16 to Float precision (head_dim=256)",
          py::arg("key_quant"),
          py::arg("key_outlier_quant"),
          py::arg("key_norm"),
          py::arg("key_outlier_norm"),
