...
interface HealthPanelProps {
  onSelect?: (
    type: "system-info" | "stale-trials" | "containers" | "harbor-jobs",
    containerTab?: "all" | "stuck",
  ) => void;
}
  ...
  return (
    <div className="border border-border rounded-lg bg-card overflow-hidden">
      ...
      >
        ...
        <div
          className={`ml-auto w-2 h-2 rounded-full ${statusColors[health.status]}`}
        />
          ...
          <div className="grid grid-cols-2 gap-2 mt-3">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div
                  className={`text-sm font-medium ${metrics.harborProcesses > 0 ? "text-green-500" : "text-red-500"}`}
                >
            ...
            <div className="pt-2 border-t border-border">
              ...
              >
                ...
                <div className="text-xs text-muted-foreground mt-1 truncate">
                  {metrics.dockerContainers.stuckContainers
                    .slice(0, 2)
                    .join(", ")}
