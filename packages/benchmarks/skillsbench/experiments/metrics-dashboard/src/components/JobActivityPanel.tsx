...
export function JobActivityPanel({
  ...
  const title =
    agent && model ? `${agent} / ${model.split("/").pop()}` : jobName;
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      ...
                      onClick={() =>
                        onTrialSelect?.(`${jobName}/${trial.trialName}`)
                      }
                    >
                      {trial.taskName}
                    </span>
                    <button
                      onClick={() =>
                        onFilesSelect?.(`${jobName}/${trial.trialName}`)
                      }
                  ...
                  <div className="mt-1 text-xs text-muted-foreground">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      <span
                        className={
                          trial.ageDurationMs > 3600000 ? "text-yellow-500" : ""
                        }
                      >
                    ...
                    {trial.startedAt && (
                      <div className="mt-1">
                        Started: {new Date(trial.startedAt).toLocaleString()}
                      </div>
                    )}
                  </div>
                </div>
              ...
              activity?.recentCompleted?.map((trial, i) => (
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      className={`ml-auto text-xs font-medium ${statusColors[trial.status] || ""}`}
                    >
                  ...
                  <div className="mt-1 text-xs text-muted-foreground">
                    ...
                    <div className="flex items-center gap-4 mt-1">
                      ...
                      {trial.reward !== null && (
                        <span
                          className={trial.reward >= 1 ? "text-green-500" : ""}
                        >
