...
export function TrialDetailPanel({ trial, onClose }: TrialDetailPanelProps) {
  ...
  const [activeTab, setActiveTab] = useState<
    "overview" | "trajectory" | "files" | "error"
  >("overview");
    ...
    <div className="border border-border rounded-lg bg-card overflow-hidden flex flex-col h-[calc(100vh-8rem)]">
      ...
      <div className="px-4 py-3 border-b border-border flex items-center justify-between bg-muted/30 shrink-0">
        <div className="flex items-center gap-2 min-w-0">
          <span
            className={`${statusColors[trial.status]} px-2 py-0.5 text-xs rounded shrink-0`}
          >
            {trial.status}
          </span>
      ...
      <div className="flex-1 overflow-auto">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <span
                    className={
                      trial.reward !== null && trial.reward >= 1
        ...
        {activeTab === "trajectory" && (
          <div className="p-2">
            ...
            {!loading && !error && !trajectory?.steps && (
  ...
  return (
    <div className="border border-border rounded-md overflow-hidden">
      ...
      >
        ...
        <span
          className={`${sourceColors[step.source]} px-1.5 py-0.5 text-xs rounded shrink-0`}
        >
          {step.source}
        </span>
