 ...
 *     bunx vitest run plugins/plugin-elizacloud/__tests__/unit/duffel-client.test.ts
 *
 ...
 * harness with a local HTTP test server in a follow-up.
 */
